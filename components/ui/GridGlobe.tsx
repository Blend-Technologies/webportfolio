...
const GridGlobe = () => {
  ...
  return (
    ...
    <div className="flex items-center justify-center absolute -left-5 top-1/2 -translate-y-1/2 w-full h-full">
      ...
      <div className="max-w-7xl mx-auto w-full relative overflow-hidden h-[40rem] px-4">
        ...
        {/* remove -bottom-20 */}
        <div className="absolute w-full h-[36rem] md:h-full z-10">
